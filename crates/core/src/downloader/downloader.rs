...
mod tests {
    ...
    fn high_throughput_profile_exposes_more_aggressive_reuse_settings() {
        ...
        assert!(
            throughput.connection_pool.max_idle_per_host
                > balanced.connection_pool.max_idle_per_host
        );
        assert!(
            throughput.connection_pool.connect_timeout < balanced.connection_pool.connect_timeout
        );
